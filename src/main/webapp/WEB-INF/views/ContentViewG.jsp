...
<div class="form-group">
	...
	<input type="text" class="form-control" id="BTitle" name="BTitle" value="${ContentView.bTitle}" readonly>
</div>
  
<div class="form-group"> 
	<label for="content">Comment:</label> 
	<textarea class="form-control" rows="10" id="BContent" name="BContent" readonly>${ContentView.bContent}</textarea> 
</div>
